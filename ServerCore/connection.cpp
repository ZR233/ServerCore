...
void connection::readHead(/*const boost::system::error_code& e*/)
{
	buf_head_ = handler_.getBufHead();
	auto self = shared_from_this();
	socket_.async_read_some(boost::asio::buffer(buf_head_),
		strand_.wrap([self,this](const boost::system::error_code& e,
	...
	void connection::readBody(/*const boost::system::error_code& e*/)
	{
